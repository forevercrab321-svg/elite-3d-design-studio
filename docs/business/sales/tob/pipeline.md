...
| Armor Games | 0 线索 | 策展；冠名或限时独占（邮件谈） | 官方未查到 | iframe 指向我们的网站 | 用户确认邮件后发送 | BD → 用户 | D4 |
| Poki | **暂缓：等路线决定** | 网页独占（或一次性授权费） | Poki 流量 50/50，自带流量 100% | `dist-portal.zip` | 用户选路线 A/B | 用户 | D1 |
